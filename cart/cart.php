...
<div class="rounded-lg border border-[#d4af37]/30 bg-[#0d2818] p-4 shadow-md sm:p-6">
  ...
  <div class="space-y-4 mt-4">
    <dl class="flex items-center justify-between gap-4">
      ...
      <dd class="text-base font-medium text-[#d4af37]">$5,694.00</dd>
    </dl>
    <dl class="flex items-center justify-between gap-4">
    ...
    <dl class="flex items-center justify-between gap-4">
      ...
      <dd class="text-base font-medium text-[#d4af37]">$99.00</dd>
    </dl>
    <dl class="flex items-center justify-between gap-4">
      <dt class="text-base font-normal text-white">Tax</dt>
      <dd class="text-base font-medium text-[#d4af37]">$398.00</dd>
    </dl>
  </div>
  <dl class="flex items-center justify-between gap-4 border-t border-[#d4af37]/30 pt-2 mt-4">
    ...
    <dd class="text-base font-bold text-[#d4af37]">$6,191.00</dd>
  </dl>
  <a href="../summary/summary.php" class="flex w-full items-center justify-center rounded-lg bg-[#d4af37] px-5 py-2.5 text-sm font-medium text-[#0d2818] hover:bg-[#e6c247] mt-4">Proceed to Checkout</a>
</div>
